...
<body>
	...
	<form action="/admin/altaConsola" method="POST" enctype="multipart/form-data" class="form_alta_consola">
		<h2>Alta Modelo Consola</h2>
		<div>
			<h4><label for="idModeloConsola">ID modelo consola</label></h4>
			<input type="text" id="idModeloConsola" name="idModeloConsola" required>		
		</div>	
		<div>
		...
		<div>
			<h4><label for="nombreCarpeta">Nombre carpeta consola</label></h4>
